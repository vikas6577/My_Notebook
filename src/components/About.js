      ...
      >
        ...
        <div style={{ "padding-left": "100px", "padding-right": "100px" }}>
          <h5>
            ...
            <br />
            Our user-friendly interface allows you to organize your notes according
            to your preference, making it easy for you to find what you're
            looking for. We understand the importance of keeping your personal
            information safe, which is why we have implemented robust security
            measures to ensure the confidentiality and privacy of your data.
            <br />
